...
# Remove the duplicate schema file
rm -f supabase/migrations/20240301000000_local_schema.sql

# Create a proper IF NOT EXISTS version of the schema
cat > supabase/migrations/20240301000000_initial_schema.sql << 'EOF'
...
echo "Schema files fixed. Please run 'docker-compose down --volumes && docker-compose up' to apply changes." 